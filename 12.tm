...
<\body>
  ...
  <\equation*>
    \<#FF5B\>a<rsub|n>=<frac|1|\<pi\>><big|int><rsub|-\<pi\>><rsup|\<pi\>>f<around*|(|x|)>cos
    n x d x,n=0,1,2\<cdots\>;
  </equation*>

  <\equation*>
    b<rsub|n>=<frac|1|\<pi\>><big|int><rsub|-\<pi\>><rsup|\<pi\>>f<around*|(|x|)>
    sin n x d x,n=0,1,2\<cdots\>;
  </equation*>

  \<#8BBE\> <math|f> \<#662F\>\<#5468\>\<#671F\>\<#4E3A\> <math|2\<pi\>>
  \<#7684\>\<#51FD\>\<#6570\>\<#FF0C\>\<#5728\><math|<around*|[|-1,1|]>>
  \<#4E0A\>\<#53EF\>\<#79EF\>\<#6216\>\<#7EDD\>\<#5BF9\>\<#53EF\>\<#79EF\>\<#FF0C\>\<#79F0\>\<#7531\>\<#4E0A\>\<#786E\>\<#5B9A\>\<#7684\>
  ...
  \<#8D8A\>\<#5F80\>\<#540E\>\<#9762\>\<#8D70\>\<#FF0C\>\<#7CFB\>\<#6570\>\<#8D8A\>\<#5C0F\>\<#FF1A\>\<#8D8A\>\<#5F80\>\<#540E\>\<#9762\>\<#8D70\>\<#FF0C\>\<#80FD\>\<#91CF\>\<#8D8A\>\<#9AD8\>\<#FF0C\>\<#5360\>\<#6BD4\>\<#8D8A\>\<#5C11\>\<#3002\>

  \<#5B9A\>\<#7406\> 12.1 (Riemann-Lebesgue \<#5F15\>\<#7406\>) \<#8BBE\>
  <math|f> \<#5728\> <math|<around*|[|a,b|]>>
